"""
源太AI🤖ハゲタカSCOPE - 生徒配布用・究極安定版
※APIアクセス・スクレイピングを完全に遮断し、キャッシュ読み込みのみに特化
"""
...
div[data-testid="stAppViewContainer"] { background: linear-gradient(180deg, #FAFAFA 0%, #FFF5F5 100%) !important; }
.main .block-container { max-width: 1200px !important; padding: 1rem 2rem 3rem 2rem !important; margin: 0 auto !important; }
h1 { text-align: center !important; font-size: 2rem !important; font-weight: 800 !important; background: linear-gradient(135deg, #C41E3A 0%, #E85A71 100%) !important; -webkit-background-clip: text !important; -webkit-text-fill-color: transparent !important; background-clip: text !important; margin-bottom: 0.5rem !important; }
.subtitle { text-align: center; color: #666; font-size: 0.95rem; margin-bottom: 1.5rem; }
.stTabs [data-baseweb="tab-list"] { justify-content: center !important; gap: 0 !important; background-color: #FFF !important; padding: 0.4rem !important; border-radius: 16px !important; box-shadow: 0 2px 12px rgba(196, 30, 58, 0.1) !important; margin-bottom: 1.5rem !important; }
.stTabs [data-baseweb="tab"] { padding: 0.75rem 2rem !important; border-radius: 12px !important; font-weight: 600 !important; font-size: 1rem !important; color: #666 !important; transition: all 0.3s ease !important; }
.stTabs [aria-selected="true"] { background: linear-gradient(135deg, #C41E3A 0%, #E85A71 100%) !important; color: white !important; box-shadow: 0 4px 12px rgba(196, 30, 58, 0.3) !important; }
.stTabs [data-baseweb="tab-highlight"], .stTabs [data-baseweb="tab-border"] { display: none !important; }
div.stButton { text-align: center !important; }
div.stButton > button:first-child { background: linear-gradient(135deg, #C41E3A 0%, #E85A71 100%) !important; color: white !important; font-weight: 700 !important; border-radius: 12px !important; border: none !important; padding: 0.85rem 2.5rem !important; box-shadow: 0 4px 15px rgba(196, 30, 58, 0.25) !important; transition: all 0.3s ease !important; font-size: 1.05rem !important; }
div.stButton > button:hover { transform: translateY(-3px) !important; box-shadow: 0 8px 25px rgba(196, 30, 58, 0.35) !important; }
.stock-card { background: white; border-radius: 16px; padding: 1.25rem; margin: 0.75rem 0; box-shadow: 0 2px 12px rgba(0,0,0,0.06); border-left: 5px solid #C41E3A; transition: all 0.2s ease; }
.stock-card:hover { transform: translateY(-2px); box-shadow: 0 4px 20px rgba(196, 30, 58, 0.15); }
.stock-card.lockon { border-left-color: #C41E3A; background: linear-gradient(135deg, #FFF 0%, #FFF5F5 100%); }
.stock-card.high { border-left-color: #F97316; background: linear-gradient(135deg, #FFF 0%, #FFF7ED 100%); }
.stock-card.medium { border-left-color: #EAB308; background: linear-gradient(135deg, #FFF 0%, #FEFCE8 100%); }
.score-badge { display: inline-block; padding: 0.35rem 0.85rem; border-radius: 20px; font-weight: 700; font-size: 0.9rem; }
.score-badge.lockon { background: linear-gradient(135deg, #C41E3A 0%, #E85A71 100%); color: white; }
.score-badge.high { background: linear-gradient(135deg, #F97316 0%, #FB923C 100%); color: white; }
.score-badge.medium { background: linear-gradient(135deg, #EAB308 0%, #FACC15 100%); color: #1a1a1a; }
.signal-tag { display: inline-block; background: #F3F4F6; padding: 0.25rem 0.6rem; border-radius: 6px; font-size: 0.8rem; margin: 0.15rem; color: #374151; }
[data-testid="stMetric"] { background: white !important; padding: 1rem !important; border-radius: 12px !important; box-shadow: 0 2px 8px rgba(0,0,0,0.04) !important; }
[data-testid="stMetricValue"] { font-size: 1.5rem !important; font-weight: 700 !important; color: #C41E3A !important; }
.stExpander { background-color: #FFFFFF !important; border: none !important; border-radius: 12px !important; box-shadow: 0 2px 8px rgba(0,0,0,0.04) !important; }
.stTextArea textarea, .stTextInput input { border-radius: 10px !important; border: 2px solid #E8E8E8 !important; font-size: 16px !important; }
.stTextArea textarea:focus, .stTextInput input:focus { border-color: #C41E3A !important; }
.hero-section { text-align: center; padding: 2rem 1rem; background: linear-gradient(135deg, #C41E3A 0%, #E85A71 100%); border-radius: 20px; color: white; margin-bottom: 1.5rem; }
.hero-section h2 { color: white !important; font-size: 1.3rem; margin-bottom: 0.5rem; }
.hero-section p { opacity: 0.9; font-size: 0.95rem; }
.status-indicator { display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.5rem 1rem; background: white; border-radius: 20px; font-size: 0.85rem; box-shadow: 0 2px 8px rgba(0,0,0,0.08); }
            ...
            if st.button("🔍 M&A分析実行", type="primary", key="ma_analyze"):
                with st.spinner("🎯 M&Aデータをキャッシュから展開中..."):
                    ...
                    if not bundle:
                        ...
                        # 【絶対防御】with_news=Falseにすることで、フロントエンドでのニューススクレイピング(通信)を完全停止
